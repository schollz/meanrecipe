...
func dataTop_5kTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/top_5k.txt", size: 3391, mode: os.FileMode(436), modTime: time.Unix(1524034503, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
