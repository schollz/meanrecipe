...
func dataTop_5kTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/top_5k.txt", size: 3896, mode: os.FileMode(438), modTime: time.Unix(1523161615, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
